...
print("Validate 50:", result1)
print("Validate -10:", result2)
print("Validate 150:", result3)
print("Safe divide 10/2:", result4)
print("Safe divide 10/0:", result5)
print("Categorize age 25:", result6)
