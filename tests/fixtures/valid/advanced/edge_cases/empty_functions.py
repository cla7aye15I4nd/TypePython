...
print(b"Return immediately:", result1)
print(b"Pass through:", result2)
print(b"Minimal conditional positive:", result3)
print(b"Minimal conditional negative:", result4)
